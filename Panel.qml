...
Panel {
  ...
  function dayName(dateString) {
    // Qt.formatDate(..., "dddd") follows the shell locale (often en_US), so use
    // the pt-BR day names from Model.js instead of the English formatter path.
    return Model.dayName(dateString)
  }
